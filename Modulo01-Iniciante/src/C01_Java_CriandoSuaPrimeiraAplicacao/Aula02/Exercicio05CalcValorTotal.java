...
public class Exercicio05CalcValorTotal {
    ...
    public void CalculoValorTotal() {
        ...
        System.out.print("Suponhamos que você possui um produto e que queira fazer um calculo do valor total deste " +
                "produto, portanto,\nDigite o valor unitário do seu produto: ");
        precoProduto = scan.nextDouble();
        System.out.print("Digite a quantidade de produtos que você possui: ");
